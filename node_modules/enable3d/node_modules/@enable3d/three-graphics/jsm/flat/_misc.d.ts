...
export declare const setOrbitControls: (orbitControls?: OrbitControls | undefined) => void;
export declare const destroy: () => void;
export declare const addObject: (object: any) => void;
export declare const clearObjects: () => void;
export declare const updateEvents: (camera: Camera) => Promise<import("three").Intersection<import("three").Object3D<import("three").Event>>[] | undefined>;
